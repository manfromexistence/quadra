            ...
            <div className="max-w-3xl space-y-3">
              <div className="space-y-2">
                ...
                <p className="text-sm leading-6 text-muted-foreground md:text-base">
                  Organise final deliverables into a structured handover
                  dossier. Track missing items, compile sections, and export the
                  master data book.
                </p>
              </div>
            </div>
                            ...
                            <div className="bg-muted/30">
                              {section.docs.length > 0 ? (
                                ...
                                <div className="px-4 py-6 text-sm text-muted-foreground italic text-center">
                                  No items defined yet — add documents from
                                  register
                                </div>
                              )}
                            </div>
                ...
                <CardContent className="text-center">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-mono">
                        {
                          DATABOOK_SECTIONS.filter((s) => s.collected === 0)
                            .length
                        }
                      </span>
                    </div>
