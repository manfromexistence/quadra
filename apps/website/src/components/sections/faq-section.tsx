...
const faqs: FAQItem[] = [
  {
    ...
    answer:
      "Quadra is a business workspace for one-person companies. It brings transactions, receipts, invoices, time tracking, and files into one connected system so you always know what's going on in your business.",
  },
  {
    question: "Who is Quadra for?",
    answer:
      "Quadra is built for founders running their company on their own who want clarity and control over their business without spending time on manual admin or spreadsheets.",
  },
  {
    question: "Do I need financial or accounting knowledge to use Quadra?",
    answer:
      "No. Quadra is designed for day-to-day use by non-financial users. It helps you stay organized, informed, and in control without requiring accounting expertise.",
  },
  {
    question: "How does Quadra connect to my bank?",
    answer:
      "Quadra connects to over 25,000 banks worldwide. Once connected, transactions are imported automatically and kept up to date.",
  },
  {
    question: "How do receipts and invoices get into Quadra?",
    answer:
  ...
  {
    question: "Can I create invoices in Quadra?",
    answer:
  ...
  {
    question: "Is Quadra secure?",
    answer:
      "Yes. Quadra uses industry-standard security practices to protect your data. You control what gets connected and shared at all times.",
  },
  {
