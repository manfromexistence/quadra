...
> = {
  reminder: {
    ...
    description:
      "Start on the lock screen, open Quadra from the push, and send a reminder without breaking focus.",
    bullets: [
      "Lock-screen alert opens directly into the iMessage thread.",
      "Quadra drafts the reminder and sends the payment link automatically.",
  ...
  "receipt-match": {
    title: "Upload a receipt and let Quadra match the transaction",
    description:
    ...
    bullets: [
      ...
      "Quadra finds the matching transaction automatically.",
  ...
  "latest-transactions": {
    ...
    bullets: [
      ...
      "Ask Quadra to flag anomalies or explain changes instantly.",
            ...
            <div className="flex flex-col items-center w-full text-center space-y-6 lg:space-y-8">
              <div className="space-y-5 lg:space-y-6 max-w-3xl 3xl:max-w-5xl mx-auto px-2 lg:px-0">
                ...
                <p className="text-muted-foreground text-base lg:text-lg leading-relaxed font-sans max-w-xl mx-auto">
                  Everything Quadra, right from chat.
                </p>

                <div className="flex justify-center pt-1">
                  <a
                    href="https://app-quadra.vercel.app/apps?app=sendblue"
