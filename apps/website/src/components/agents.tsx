      ...
      <div className="overflow-hidden border border-border">
        ...
        >
          ...
          <div className="text-[hsl(225,60%,75%)] text-[10px] tracking-widest mt-1.5 mb-5">
            v0.1.0 · agent@acme.corp · Quadra Labs AB
          </div>
...
const possibilities = [
  ...
  },
  {
    ...
    description:
      "Any app that speaks MCP gets instant access to 80+ Quadra tools. No custom integration code, no API wrangling.",
  },
  {
    agent: "Raycast",
        ...
        <div className="lg:max-w-[590px] space-y-8 w-full">
          <div>
            ...
            <p className="text-[hsl(225,60%,75%)] text-base leading-normal mt-4 md:mt-8">
              ...
              transactions, track time, pull reports. Anything you do in Quadra,
              it can do too.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Link href="https://app-quadra.vercel.app">Start automating</Link>
            </Button>
            <Button
              asChild
              variant="outline"
      ...
      <div className="space-y-16 max-w-screen-lg mx-auto">
        ...
        <div className="hidden md:block text-center">
          ...
          <p className="text-[hsl(225,60%,75%)] text-base leading-normal mt-4 max-w-md mx-auto">
            Quadra is the backbone. Agents connect via MCP, CLI, or API. Every
