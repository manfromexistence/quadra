            ...
            <div className="space-y-4 mb-12">
              <a href={cursorDeepLink} className="inline-block">
                <img
                  ...
                  alt="Add Quadra MCP server to Cursor"
                  height={32}
              ...
              <p className="font-sans text-xs text-muted-foreground">
                ...
                OAuth. You'll be prompted to sign in when you first use a Quadra
                tool.
              </p>
            </div>
            ...
            <div className="mt-12 space-y-4">
              ...
              <ol className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    When you first use a Quadra tool, you'll be prompted to sign
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span className="font-sans text-sm text-muted-foreground pt-0.5">
                    @-mention Quadra in chat to access your financial data
                  </span>
                </li>
              </ol>
            </div>
