...
Most bank exports work directly. Quadra maps common formats automatically.
...
4. Map columns to Quadra fields
5. Review the preview
6. Confirm import

## Column mapping

If Quadra doesn't recognize your columns automatically:

1. Match each CSV column to a Quadra field
...
- Quadra checks for duplicates based on date, amount, and description
