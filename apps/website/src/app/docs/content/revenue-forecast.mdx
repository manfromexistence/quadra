...
Your revenue forecast shows how much money you can expect to receive in the coming months. Unlike simple projections that just extend past trends, Quadra builds your forecast from real, known sources of incoming revenue.
...
1. Go to [Overview](https://app-quadra.vercel.app)
...
- **Projected revenue**: What Quadra expects you'll receive (dashed line)
- **Confidence score**: How reliable the projection is

## How the forecast works

Quadra calculates your forecast by adding up known and expected revenue sources. This "bottom-up" approach is more accurate than simply assuming past trends will continue.
...
To keep forecasts realistic, Quadra automatically excludes:
...
The more information Quadra has, the better your forecast:
...
When you [track billable hours](/docs/track-time-timer), Quadra can estimate unbilled revenue. Link your tracked time to projects with hourly rates.
...
Set your base currency in [Settings](https://app-quadra.vercel.app/settings).
...
Quadra may show warnings on your forecast:
...
**"Limited history"**: Not enough historical data to calculate reliable baselines. Accuracy improves as you use Quadra longer.
