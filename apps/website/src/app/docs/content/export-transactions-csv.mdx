...
description: How the transaction export flow works in Quadra.
section: export
order: 1
---

Quadra tracks each transaction through a clear lifecycle so you always know what needs attention and what's been exported.
...
| **Receipt found** | Quadra found a possible receipt match. Confirm or dismiss it. |
...
2. Quadra finds a matching receipt automatically (status: **Receipt found**)
...
| **Mark exported** | Manually marks as exported (use only if exported outside Quadra) |
