...
Customers in Quadra store the information you need for invoicing and tracking work.

## Add a customer

1. Go to [Customers](https://app-quadra.vercel.app/customers)
...
Quadra can automatically enrich customer profiles:
