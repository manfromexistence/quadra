...
description: Get your OAuth app verified and listed in the Quadra app directory.
section: developer
order: 5
---

Once your OAuth app is working, you can submit it for review. Verified apps display a trust badge and can be listed in the Quadra app directory for users to discover.

## Why get verified?

### For users

- **Trust badge**: Verified apps show users that Quadra has reviewed the app
...
- **App directory listing**: Reach Quadra's user base
- **Partnership opportunities**: Connect with the Quadra team
...
- Apps work fully
- Users see a warning: "This app hasn't been verified by Quadra yet"
...
- [ ] App works with different Quadra accounts
...
After approval, you can opt to list your app in the Quadra app directory:
...
- Don't include "Quadra" unless you have permission
- Avoid misleading names that imply official Quadra features
