...
description: Technical reference for Quadra OAuth 2.0 endpoints.
section: developer
order: 4
---

Complete technical reference for Quadra's OAuth 2.0 implementation. These endpoints follow the [OAuth 2.0 RFC 6749](https://tools.ietf.org/html/rfc6749) and [PKCE RFC 7636](https://tools.ietf.org/html/rfc7636) specifications.

## Base URLs

| Environment | URL |
|-------------|-----|
| Authorization | `https://app-quadra.vercel.app/oauth` |
...
```
GET https://app-quadra.vercel.app/oauth/authorize
```
...
Once you have an access token, use the Quadra SDK for API requests:
