...
Quick solutions to common issues you might encounter with Quadra.
...
1. Check the connection is still active in [Inbox Settings](https://app-quadra.vercel.app/inbox/settings)
...
1. Verify Stripe is connected in [Invoice Settings](https://app-quadra.vercel.app/settings/invoice)
...
1. Go to [Settings → Billing](https://app-quadra.vercel.app/settings/billing)
