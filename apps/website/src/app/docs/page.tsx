...
export const metadata = createPageMetadata({
  title: "Documentation",
  description:
    "Learn how to use Quadra to run your business. Get answers about invoicing, banking, time tracking, reports, and more.",
  path: "/docs",
  og: {
    title: "Documentation",
    description: "Everything you need to know about Quadra",
  },
});
...
const popularGuides = [
  {
    ...
    description: "What is Quadra and how it helps you",
  },
  {
    title: "Quick Start",
