...
const config = {
  ...
  description:
    "Connect Quadra to iMessage and manage your finances without leaving your conversations. Send a photo of a receipt, ask about your cash flow, create an invoice — Quadra handles it all through natural conversation.",
  steps: [
    {
      title: "Open Apps in Quadra",
      description:
        "Go to the Apps section in your Quadra dashboard and find iMessage.",
