...
const title = `Compare Quadra to QuickBooks, Xero, FreshBooks & More (${year})`;
const description =
  "Looking for QuickBooks, Xero, or FreshBooks alternatives? Compare Quadra to popular accounting and finance tools. Built for founders, not accountants. Free 14-day trial.";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Compare Quadra to alternatives",
      },
    ],
  },
  twitter: {
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <h1 className="font-serif text-3xl lg:text-4xl text-foreground mb-4">
            Compare Quadra to alternatives
          </h1>
          <p className="font-sans text-base text-muted-foreground max-w-2xl mx-auto">
            Quadra is built for founders and small teams who want clarity over
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild className="btn-inverse h-11 px-6">
                <a href="https://app-quadra.vercel.app/">Start your free trial</a>
              </Button>
