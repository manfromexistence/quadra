...
export const metadata = createPageMetadata({
  ...
  description:
    "Terms and Conditions for using Quadra. Read about your rights and responsibilities when using our service.",
  path: "/terms",
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  govern your relationship with the Quadra application (the
                  "Service") operated by Quadra EDMS ("us", "we", or "our").
                </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    cancel it or Quadra Labs AB cancels it. You may cancel your
                    Subscription through your online account management page or
                    by contacting Quadra Labs AB's customer support.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If automatic billing fails, Quadra Labs AB will issue an
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB may modify Subscription fees at its sole
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    and are granted at the sole discretion of Quadra Labs AB.
                  </p>
                </section>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB does not verify the accuracy or suitability
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB is not a financial advisor, accountant, or
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB accepts no liability for any consequences,
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    providers. Quadra Labs AB does not verify the legal, tax, or
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB relies on third-party services (e.g., banking
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      Quadra Labs AB cannot guarantee the completeness,
                    ...
                    <li>
                      Quadra Labs AB shall not be liable for any loss, damage,
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    <li>
                      Quadra Labs AB acts solely as a technical facilitator of
                    ...
                    <li>
                      Quadra Labs AB is not responsible for errors, omissions,
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    remain the property of Quadra Labs AB and its licensors.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    services that are not controlled by Quadra Labs AB.
                  </p>
                  <p className="text-muted-foreground leading-relaxed">
                    We assume no responsibility for third-party content, privacy
                    policies, or practices. You agree that Quadra Labs AB shall
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB and its affiliates, directors, employees, and
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    Quadra Labs AB regarding the Service.
                  </p>
                </section>
