...
export const metadata = createPageMetadata({
  ...
  description:
    "Privacy Policy for Quadra. Learn how we collect, use, and protect your personal data.",
  path: "/policy",
  og: {
    title: "Privacy Policy",
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-sm sm:prose-base max-w-none space-y-6 font-sans text-foreground">
                <p className="text-muted-foreground leading-relaxed">
                  Quadra Labs AB ("us", "we", or "our") operates the Quadra
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Service is the Quadra application operated by Quadra
                        Labs AB
                      </p>
                    </div>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB uses the collected data for various purposes:
                  </p>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra's use of information received from Google APIs will
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    If you are from the European Economic Area (EEA), Quadra
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB may process your Personal Data because:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB will retain your Personal Data only for as
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB will also retain Usage Data for internal
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Quadra Labs AB will take all the steps reasonably necessary
                ...
                <section className="space-y-4">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        If Quadra Labs AB is involved in a merger, acquisition
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Under certain circumstances, Quadra Labs AB may be
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        Quadra Labs AB may disclose your Personal Data in the
                        good faith belief that such action is necessary to:
                      </p>
                      <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                        <li>To comply with a legal obligation</li>
                        <li>
                          To protect and defend the rights or property of Quadra
                          Labs AB
                        </li>
                        <li>
                ...
                <section className="space-y-4">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    you have certain data protection rights. Quadra Labs AB aims
                  ...
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                    ...
                    <li>
                      ...
                      Quadra Labs AB relied on your consent to process your
                      personal information.
                    </li>
                  </ul>
                  <p className="text-muted-foreground leading-relaxed mt-2">
