...
<br />
We have updated our import solution to support CSV, PDF, and screenshots of transactions to help as many users as possible get started with Quadra.
...
Give these a try and let us know what you think [get started here](https://app-quadra.vercel.app).
