...
export const metadata = createPageMetadata({
  ...
  description:
    "Connect Perplexity to your Quadra data via MCP. Query transactions, invoices, and financial reports with natural language AI search.",
  path: "/mcp/perplexity",
  og: {
    title: "Perplexity + Quadra",
