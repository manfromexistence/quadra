...
export const metadata = createPageMetadata({
  ...
  description:
    "Connect OpenCode to your Quadra data via MCP. Track time for client projects, start timers, and log hours directly from your terminal.",
  path: "/mcp/opencode",
  og: {
    title: "OpenCode + Quadra",
